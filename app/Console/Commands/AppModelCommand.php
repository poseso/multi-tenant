...
class AppModelCommand extends AppGeneratorCommand
{
     ...
     * @var string
     */
    protected $description = 'Create a new Eloquent model class with Controller class, attribute, relationship, scope traits and repository class';
    ...
    {
        return [
            'all', 'paginated', 'find', 'create', 'update', 'delete',
        ];
    }
    ...
    public function handle()
    {
        if (parent::handle() !== false) {
            $this->call('app:controller', ['name' => $this->argument('name'), '--namespace' => $this->option('namespace')]);
            ...
            $this->call('app:repository', ['name' => $this->argument('name'), '--namespace' => $this->option('namespace')]);
