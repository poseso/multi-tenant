		...
		var handleMessaging = function() {
			...
			var html =
				...
				'<div class="kt-chat__user">' +
					...
					'<a href="#" class="kt-chat__username">Carlos Sanchez</span></a>' +
			...
			setTimeout(function() {
				...
				let html =
					...
					'<div class="kt-chat__user">' +
						...
						'</span>' +
						'<a href="#" class="kt-chat__username">Giancarlo Alfau</span></a>' +
						'<span class="kt-chat__datetime">Justo ahora</span>' +
					'</div>' +
					'<div class="kt-chat__text">' +
                    'Buenas tardes! gracias por comunicarse con nosotros. <br>En que podemos ayudarle en el día de hoy.'
					'</div>';
...
let KTQuickPanel = function() {
    ...
    let notificationPanel = KTUtil.get('kt_notifications');
    let logsPanel = KTUtil.get('kt_logs');
    let settingsPanel = KTUtil.get('kt_settings');

    let getContentHeight = function() {
        let height;
        let nav = KTUtil.find(panel, '.kt-quick-panel__nav');
        let content = KTUtil.find(panel, '.kt-quick-panel__content');
    ...
    let initOffcanvas = function() {
        let offcanvas = new KTOffcanvas(panel, {
            overlay: true,
            baseClass: 'kt-quick-panel',
            closeBy: 'kt_quick_panel_close_btn',
            toggleBy: 'kt_quick_panel_toggler_btn'
